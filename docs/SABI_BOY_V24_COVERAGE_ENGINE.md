...
Status: implementation candidate on `feature/v2-coverage-engine`
...
12. if a metered sensor is enabled for acceptance, cap the test tightly and record quota before/after;
13. verify the System dashboard funnel on desktop/mobile/PWA;
14. verify the coverage timer, research timer and rollback posture.
