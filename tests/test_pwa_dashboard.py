...
def test_dashboard_exposes_installable_pwa_shell_and_backdrop_only_mobile_close():
    ...
    assert all("?v=2.4.0.0" in icon["src"] for icon in data["icons"])
    ...
    assert '/assets/app.js?v=2.4.0.0' in shell.text
    assert '/assets/app.css?v=2.4.0.0' in shell.text
    ...
    assert '<img class="brand-mark" src="/assets/icon-192.png?v=2.4.0.0" alt="">' in shell.text
